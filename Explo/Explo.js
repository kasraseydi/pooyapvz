...
export default class Explo extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Wallnut_body", "./Explo/costumes/Wallnut_body.svg", {
        x: 50.00000000000003,
        y: 50,
      }),
      new Costume("Wallnut_body2", "./Explo/costumes/Wallnut_body2.svg", {
        x: 54.047619999999995,
        y: 96,
      }),
      new Costume("blink 0", "./Explo/costumes/blink 0.svg", {
        x: 23.961405310964352,
        y: 73.0329534170216,
      }),
      new Costume("blink 1", "./Explo/costumes/blink 1.svg", {
        x: 23.983325000000008,
        y: 73.01667,
      }),
      new Costume("blink 2", "./Explo/costumes/blink 2.svg", {
        x: 23.961405000000013,
        y: 73.032955,
      }),
      new Costume("blink 3", "./Explo/costumes/blink 3.svg", { x: 0, y: 0 }),
      new Costume("pos", "./Explo/costumes/pos.svg", { x: 140.5, y: 140.5 }),
      new Costume("col", "./Explo/costumes/col.svg", {
    ...
    this.sounds = [
      new Sound("plant", "./Explo/sounds/plant.mp3"),
      new Sound("chompsoft", "./Explo/sounds/chompsoft.mp3"),
      new Sound("gulp", "./Explo/sounds/gulp.mp3"),
      new Sound("bowlingimpact2", "./Explo/sounds/bowlingimpact2.mp3"),
      new Sound("bowling", "./Explo/sounds/bowling.wav"),
    ];
      ...
      if (this.toString(this.vars.state) === "grabbed") {
        ...
        if (this.touching(this.sprites["Zombies"].andClones())) {
          if (this.toString(this.vars.firstFirst) === "yes") {
            yield* this.startSound("bowlingimpact2");
            this.vars.y -= 15;
            this.costume = "pos";
            this.goto(this.toNumber(this.vars.x), this.toNumber(this.vars.y));
            this.costume = "col";
