...
export default class Pea2 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("PeaShooter_Head", "./Pea2/costumes/PeaShooter_Head.svg", {
        x: 35,
        y: 32.505390000000006,
      }),
      new Costume("blink 0", "./Pea2/costumes/blink 0.svg", {
        x: 2.00621000000001,
        y: 21.498304999999988,
      }),
      new Costume("blink 1", "./Pea2/costumes/blink 1.svg", {
        x: 2.0065350000000137,
        y: 21.5,
      }),
      new Costume("blink 2", "./Pea2/costumes/blink 2.svg", {
        x: 2.00621000000001,
        y: 21.498304999999988,
      }),
      new Costume("blink 3", "./Pea2/costumes/blink 3.svg", { x: 0, y: 0 }),
      new Costume(
        "PeaShooter_stalk_bottom",
        "./Pea2/costumes/PeaShooter_stalk_bottom.svg",
        { x: 20.030665204678343, y: 34.90902777777757 }
      ),
      new Costume(
        "PeaShooter_frontleaf",
        "./Pea2/costumes/PeaShooter_frontleaf.svg",
        { x: 40.4967320261438, y: 20 }
      ),
      new Costume(
        "PeaShooter_backleaf",
        "./Pea2/costumes/PeaShooter_backleaf.svg",
        { x: 22.388888888888914, y: 11 }
      ),
      new Costume(
        "PeaShooter_sprout",
        "./Pea2/costumes/PeaShooter_sprout.svg",
        { x: 16.039228421067293, y: 6.925902858725607 }
      ),
    ];

    this.sounds = [
      new Sound("plant", "./Pea2/sounds/plant.mp3"),
      new Sound("chompsoft", "./Pea2/sounds/chompsoft.mp3"),
      new Sound("gulp", "./Pea2/sounds/gulp.mp3"),
      new Sound("throw", "./Pea2/sounds/throw.mp3"),
      new Sound("throw2", "./Pea2/sounds/throw2.mp3"),
    ];
  ...
  *animate() {
    ...
    this.x -= 16;
    this.direction =
      Math.sin(this.degToRad(this.toNumber(this.vars.sin))) * 20 + 80;
    this.size = 70;
    this.stamp();
    this.vars.y += 25;
  }
    ...
    while (true) {
      ...
      if (this.toString(this.vars.state) === "grabbed") {
        ...
        if (this.toString(this.vars.first) === "yes") {
          yield* this.layer();
          this.stage.vars.grid.splice(this.vars.grid - 1, 1, "pea");
  ...
  *startAsClone2() {
    ...
    if (
      ...
      this.stage.vars.timerReset = "pea";
